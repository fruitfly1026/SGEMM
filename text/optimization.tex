...
The assembly code in Algorithm~\ref{fig:order} \jled{where is the algorithm?} lists the instructions to calculate $C_{32},C_{22}, C_{21}, C_{30}, C_{31}, C_{20}$, where are corresponding to the orders of $6,7,8,9,10,11$ in Figure~\ref{fig:reg}. 
