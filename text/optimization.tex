...
cells denote {\tt FFMA} execution order. Dashed ellipses across two cells mean that two {\tt FFMA} instructions are dual
    issued in one clock cycle.}%\jled{Get rid of colors here.}}
\label{fig:order}
\end{center}
\end{figure}
