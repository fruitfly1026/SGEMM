...
demystifies plenty of GPU microarchitecture features such as instruction issue, warp scheduling, register bank distribution, and control code\jli{+what?}, to help understand and optimize the performance of a computational program. 
