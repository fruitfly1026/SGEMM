...
demystify plenty of GPU microarchitecture features such as instruction issue,
warp scheduling, register bank distribution, and control code%jli{+what?}, 
which helps understand and optimize the performance of a computational program. 
...
\item We design a microbenchmark suite to explore undocumented microarchitecture features of NVIDIA GPUs, such as control codes regulating {\tt FFMA} instruction dual issue and register bank distribution, % \jli{name another one, because it is a set of benchmarks}, 
    which are necessary to understand and tune GPU programs.
...
The experience of 
exploring bare-metal optimizations is helpful %\jli{``valuable'' may be too much} 
to compiler development and performance tuning.
