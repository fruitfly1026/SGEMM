...
We wrote a simple PTX code generator, which generates PTX code with various modifiers.
...
Another feasible way is to enumerate all of possible binary combinations after striping out operand mask.
