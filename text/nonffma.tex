...
Thus, $143-77 + 144\times 2 + 65=419$ ($>350$) instructions are between them, which is enough to hide the latency of {\tt LDG}s.
...
Other instructions such as {\tt XOR}, {\tt IADD}, and {\tt ISETP} are inserted according to data dependency; they don't influence the performance because of their short latencies.
\begin{table}[htbp]
