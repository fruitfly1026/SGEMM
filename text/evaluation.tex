...
% our {\tt FFMA} throughput optimization which including elimanating
% register banks, choosing proper load width. 
% Our SGEMM currently achieves at the red line. 
...
% For SGEMM, by $12\times12$, the ratio is $3$, by $8\times 8$ blocking, the ratio is $2$. 
