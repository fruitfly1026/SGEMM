...
SGEMM performance increases with matrix sizes in Figure~\ref{fig:rect} . 
...
The slope of slant line in Figure~\ref{fig:roofline_all} is global memory bandwidth. The x-axis is computation to global
...
The slope of slant line in Figure~\ref{fig:roofline_all} is the bandwidth of shared memory. The x-axis is computation to
