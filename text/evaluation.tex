...
\hline
32-bit registers/SM&64K \jled{Use actual number}\\
\hline
LD/ST unit&32 \\
\hline
...
\jled{the next sentence change to ``On the one hand, a larger matrix has a higher arithmetic intensity, which is the ratio of compulsory floating-point operations to the total DRAM memory traffic.
...
Since Kepler has $13$ SMs in total, matrix $768\times 768$ suffers imbalance from scheduling the $3$ extra blocks. 
