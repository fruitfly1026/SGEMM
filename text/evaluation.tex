...
The experiments are conducted on NVIDIA K20m GPU, and the detailed specification of its hardware configuration can be found in~\cite{}. We compare with cuBLAS from CUDA $7.0$. In our experiments, we choose square matrices for $A$, $B$
