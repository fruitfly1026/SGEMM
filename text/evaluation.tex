...
{\it +LDG128:}~~Use the faster texture cached {\tt LDG} instead of L2-cached {\tt LD} along with {\tt TEXDEPBAR} before data accesses due to the weak consistency of texture cache~\cite{lukyanov2014efficient}.
