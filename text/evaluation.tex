...
shared
memory, global memory, and computation power. In register blocking loop, each thread block computes $bm*bn*bk$ and reads $bm*bk+bn*bk$ words. The upper bound of global memory bandwidth can be modeled as:
\begin{equation}
