...
\begin{figure*}
    \begin{subfigure}[htbp]{0.3\textwidth}
       ...
       \subcaption{Regulate {\tt FFMA} throughput. \jled{8-bit control code value}}
    ...
    \end{subfigure}
    \caption{Different control code impact on performance \jled{Why not just draw 16 values for $0-3$ bits with fixed $4-7$ bits. It's hard to explain the these figures here! }}
...
While two consecutive instructions are controlled by {\tt 0x04} and {\tt 0x05} respectively, the throughput 
