...
For the eight control bits, we identify their meanings by statistically examining CUBLAS disassembly codes and dynamtically benchmarking instruction sequence of different control codes. We observe that the $7$th bit of the control code of {\tt TEXDEPBAR} instruction is $1$, which
...
\begin{itemize}
\item When the control bits are set to be $0x40$, the scheduler suspends a warp of the instructions for $38$ cycles.
