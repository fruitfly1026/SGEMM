...
Figure~\ref{fig:warp} shows mapping of {\tt FFMA} instructions to cores on one SM. There are $32\times 6=192$ cores on
one SM, the middle $32$ cores are shared by two warp schedulers, $4$ warp schedulers are available. 
...
The jagged green and red blocks shows a proper phase shift among two warp's executing pace, so that they could get
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[scale=0.7]{warp}
