...
{\em {\bf Benchmarking}}: 
Fog~\cite{fog} did a sound work on benchmarking instruction latency and throughput of several generations of Intel/AMD CPUs and Intel Xeon Phi accelerations. %The benchmarks focused on instruction latency, throughput and memory.
