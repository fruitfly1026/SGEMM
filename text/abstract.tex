...
performance factors.
We uncover microarchitectural features, such as dual issue impact on float arithmetic throughput, memory load width on bandwidth,
and register bank on performance. 
