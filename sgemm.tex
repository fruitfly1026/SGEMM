...
\setlength{\textfloatsep}{4pt} % plus 0.5pt minus 0.5pt} 
...
\authorinfo{\small Xiuxia Zhangi$^1$ \and Guangming Tan$^1$ \and Shuangbai Xue$^1$ \and Jiajia Li$^2$ \and Keren Zhou$^1$ \and Mingyu Chen$^1$}
...
%\authorinfo{\small Jiajia Li$^2$ \and Keren Zhou$^1$ \and Mingyu Chen$^1$}
%           {Affiliation3/4}
%           {Email2/3}
%\authorinfo{Keren Zhou \and Mingyu Chen}
 %          {Affiliation1}
 %          {Email1}
